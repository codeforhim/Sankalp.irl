        ...
        <div className="flex flex-col flex-1 space-y-3">
            {summary ? (
                <>
                    ...
                    <button onClick={generateSummary} disabled={loading} className="flex items-center justify-center space-x-2 text-xs text-[#6B7280] hover:text-[#1B3A6F] transition mt-1">
    ...
    return (
        <div className="w-full max-w-7xl mx-auto p-4 md:p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm p-5 flex flex-col">
                    <h2 className="text-lg font-semibold text-[#1F2937] border-b border-[#E5E7EB] pb-2 mb-4">AI Ward Summary</h2>
