...
const ChatWidget = ({ role, userId, extraContext = {} }) => {
    ...
    const handleSend = async (e) => {
        ...
        try {
            ...
            // For local docker-compose, assuming frontend maps to localhost:7860 for the agents
            const API_URL = import.meta.env.VITE_AGENTS_URL || 'http://localhost:7860';
            ...
            setMessages(prev => [...prev, { 
                id: Date.now(), 
                text: "I'm having trouble connecting to my neural network right now. Please make sure the Agent Service is running on port 7860.", 
                sender: 'bot',
                actions: [] 
            }]);
        } finally {
